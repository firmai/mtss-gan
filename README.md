...
The algorithm, due to its nature is somewhat unstable. My hope is that future iterations will bring more stability to the generation process. The metrics section also has two errors that I have to come around to. Please experiment with the code in the colab below and give me your feedback in the issues tab. I will read it to improve a future version of this model.
